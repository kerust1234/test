...
public class TestTran110
{
	...
	public static String Test_API110() throws Exception
	{
		...
		cal.add(Calendar.HOUR_OF_DAY, -4);  //end time set to 4 hours ago
		endTime= df.format(cal.getTime());
		cal.add(Calendar.HOUR_OF_DAY, -24); //start time set to 1 day before end time
...
/*		SimpleDateFormat Format = new SimpleDateFormat("yyyy-MM-dd");
		...
		System.out.println("返回信息：\r" + respMsg);
                return respMsg;
	}
